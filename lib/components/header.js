...
var InputGroup = _styledComponents.default.div(_templateObject3());

var InputDevider = _styledComponents.default.div(_templateObject4());

var BtnStyle = _styledComponents.default.button(_templateObject5());

var DismissBtn = _styledComponents.default.button(_templateObject6());

var DismissBtnLine = _styledComponents.default.span(_templateObject7());

var RotateIcon = _styledComponents.default.span(_templateObject8());
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(HeaderStyle, null, _react.default.createElement(_context.DeviceModeContext.Consumer, null, function (context) {
        ...
        }, header, _react.default.createElement("select", {
          defaultValue: context.state.defaultDevice,
          onChange: function onChange(e) {
            context.actions.updateDevice(e.target.value);
          }
        }, context.state.devices.map(function (device, index) {
        ...
        }, _react.default.createElement(RotateIcon, null))), sub), hasCloseBtn && _react.default.createElement(DismissBtn, {
