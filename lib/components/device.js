...
var DeviceWrapper = _styledComponents.default.div(_templateObject4(), deviceAnimation, function (props) {
  if (props.scale === -1) {
...
var DeviceScreen = _styledComponents.default.iframe(_templateObject5(), function (props) {
  return !props.isLoading ? 'display: block;' : 'display: none;';
});

var LoadingScreen = _styledComponents.default.div(_templateObject6());

var Spinner = _styledComponents.default.div(_templateObject7(), spinnerAnimation);
