...
var DeviceScaler = _styledComponents.default.div(_templateObject4(), function (props) {
  ...
  return "".concat(1 / props.scale * 1000, "px !important");
}, function (props) {
  return "\n        left: ".concat(100 / props.scale * 2, "px;\n        width: ").concat(100 / props.scale * 2, "px;\n        height: ").concat(100 / props.scale * 15, "px;\n        margin-top: -").concat(100 / props.scale * 7.5, "px;\n      ");
}, function (props) {
  return "\n        left: ".concat(100 / props.scale * 6, "px;\n        width: ").concat(100 / props.scale * 2, "px;\n        height: ").concat(100 / props.scale * 15, "px;\n        margin-top: -").concat(100 / props.scale * 7.5, "px;\n      ");
}, function (props) {
  return "".concat(1 / props.scale * 1000, "px !important");
}, function (props) {
  return "\n        top: ".concat(100 / props.scale * 2, "px;\n        height: ").concat(100 / props.scale * 2, "px;\n        width: ").concat(100 / props.scale * 15, "px;\n        margin-left: -").concat(100 / props.scale * 7.5, "px;\n      ");
}, function (props) {
  return "\n        top: ".concat(100 / props.scale * 6, "px;\n        height: ").concat(100 / props.scale * 2, "px;\n        width: ").concat(100 / props.scale * 15, "px;\n        margin-left: -").concat(100 / props.scale * 7.5, "px;\n      ");
}, function (props) {
  return "".concat(1 / props.scale * 1000, "px !important");
}, function (props) {
  return "".concat(1 / props.scale * 1000, "px !important");
