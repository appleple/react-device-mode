...
var DeviceContainer = _styledComponents.default.div(_templateObject());
...
function (_Component) {
  ...
  function Device() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(Device).apply(this, arguments));
  }
    ...
    value: function render() {
      ...
      return _react.default.createElement(_context.DeviceModeContext.Consumer, null, function (context) {
        return _react.default.createElement(DeviceContainer, null, _react.default.createElement(_reResizable.default, {
          enable: _this.getRisizeConf(context.state.resizable),
          size: _this.getSize(context.state),
        ...
        }, _react.default.createElement(DeviceWrapper, _defineProperty({
        ...
        }, "resizable", context.state.resizable), _react.default.createElement(DeviceScreen, {
          key: context.state.ua,
          src: "".concat(context.state.src, "?ua=").concat(context.state.ua),
