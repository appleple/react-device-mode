...
var DeviceContainer = _styledComponents.default.div(_templateObject2(), FrameTop + 20);

var DeviceWrapper = _styledComponents.default.div(_templateObject3(), deviceAnimation, function (props) {
  if (props.scale === -1) {
...
var DeviceScreen = _styledComponents.default.iframe(_templateObject4());
